...
- [AI Router](https://ai-router.dev) - OpenAI-compatible ChatGPT API relay for developers with user API keys, usage and token/cost visibility, daily/weekly packages, and staged new-user credit.
